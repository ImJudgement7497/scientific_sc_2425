...
#SBATCH --output=./logs/parallel_logs/Q3_%j.log           # Standard out and error log
...
g++ -fopenmp packing/packing_parallel.cpp -o main_packing_parallel
export OMP_NUM_THREADS=96
time ./main_packing_parallel
