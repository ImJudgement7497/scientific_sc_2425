...
// double do_sin_sum(double &num)
// {
//     return sqrt(abs(sin(num)));
// }
...
//             */
//             double y = sqrt(abs(sin(((i + 1) * (i + 1))))) - compensation;
//             double t = sum + y;
//             compensation = (t - sum) - y;
//             sum = t;
//         }

//         sum = 0.5 * (N) * (N + 1) + sum * 2.34;
...
//                 for more accurate sums when N is very large
//                 */
//                 double y = sqrt(abs(sin(((i + 1) * (i + 1))))) - local_compensation;
...
//         total_sum = 0.5 * (N) * (N + 1) + total_sum * 2.34;
